	...
	*/
	...
	$.getJSON("ajax/get_userinfo.php",{"userId":sessionStorage.userId},function(data){
		...
		Tlb
			...
			.append(
				$("<button style='width:150px;' id='ticketDepartment' href='#' name='ticketDepartment' data-select-items='"+JSON.stringify(data.departments)+"' class='selectButton'>"+data.userInfo.tickets.departmentName+"</button>")
			)
			.append(
