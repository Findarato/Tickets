<div class="colorWhite-1" style="width:auto;margin-left:5px;font-size:100%;line-height:20px" title="Update Notes">
  <div class="" id="">
    <div style="padding:5px;margin:5px; ; overflow:auto;position:relative;background-color:#FFF" class="roundAll4 border-all-A-1">
      ...
      <br>
      <span style="font-size: 150%; line-height: normal;">Bug Fixes</span>
      <ol>
        <li>Fixed a bug relating to the admin section not showing any options other than user edit</li>
        <li>Fixed a bug that was causing the title title text to use the wrong font</li>
        ...
        <li>Fixed the bugs relating to the custon drop down boxes. They now opperate properly. This also includes the user dropdown.
          <ol>
      ...
      <ol>
        <li>Working on making tickets fit with the new website colors and feel. When the new website launches tickets should already feel right at home</li>
        ...
        <li>Features now 100% work.  There might be a few bugs that need to be worked out but so far I think they are actually working</li>
      </ol>
      <br>
      ...
      <ol>
        ...
        <li>Search is currently missing from the layout. I am working on a location to put it so that it fits</li>
      </ol>
      <br>
      <br>
      <div style="padding:5px;margin:5px; ; overflow:auto;position:relative;background-color:#FFF" class="roundAll4 border-all-A-1">
        ...
        <span style="font-size: 90%; line-height: normal;" id="version" title="Ticket Update version number">v.3.2.0.r412</span>
        <br>
        <span style="font-size: 150%; line-height: normal;">Bug Fixes</span>
        <ol>
          <li>Fixed [bug=742].</li>
          <li>Fixed a regression that was causing some text to be white, thus making it un readable</li>
          <li>Fixed a few bugs relating to adding tickets</li>
          <li>Converted more of the old theme bugs to the new CSS</li>
          <li>Updated some buttons</li>
        </ol>
        <br>
        <span style="font-size: 150%; line-height: normal;">New Features</span>
        <ol>
          ...
          <li>Closed tickets are now separated into two areas, to better explain what each one did.</li>
        </ol>
        <br>
        <span style="font-size: 150%; line-height: normal;">Known Issues</span>
        <ol>
        ...
        <ol>
          ...
          <li>Closed tickets that are linked using the [ticket=###] link style will now look like [bug=693]<del><a class="bug" href="#ticket/693">#693</a></del></li>
        </ol>
        <br>
        <span style="font-size: 150%; line-height: normal;">Known Issues</span>
        <ol>
        ...
        <ol>
          ...
          <li>Bookmarks are now done in line vs though a toolbar button. You can click the (
          <div class="ilb bookmark-off ticketSprite">
          </div>
          /
          <div class="ilb bookmark ticketSprite">
          </div>
          ) icon anywhere it is on the page, and it will toggle the book mark for the ticket you have selected.</li>
          <li></li>
        </ol>
        <br>
        <span style="font-size: 150%; line-height: normal;">Known Issues</span>
        ...
        <span style="font-size: 150%; line-height: normal;">Bug Fixes</span>
        <br>
        1. The Update notes page was using the old theme. This has been fixed. <br>
        2. Fixed a bug that was causing bookmarked checks to apear on replies. <br>
        <br>
        <span style="font-size: 150%; line-height: normal;">New Features</span>
        <br>
        1. Navagation has been made dramatically easier, and more to the point. All tickets are selected though the ticket list. This will reducde the amount of CSS needed, as well as allow for the reduction in a lot of the javascript as well. <br>
        2. Look and feak of tickets has changed. No longer are the areas separated from their headers. <br>
        3. CSS3 has attacked tickets. There are now lots of cool new CSS3 tags running rampant around tickets. If you see square corners and no drop shadows you are using an old browser. <br>
        4. there is now an [ img ] tag. it allows for linking to offsite images within tickets. No matter what size it is, it will work. <br>
        <br>
        <span style="font-size: 150%; line-height: normal;">Known Issues</span>
        <br>
        1. Large Graphs are still not working properly <br>
        2. Some themes do not work 100% <br>
        3. There are no page numbers, nor any way to show more then the default amount of tickets in the list view. <br>
        4. Problem or bug icons do not show up in the ticket list. <br>
        <br>
        ...
        <span style="font-size: 150%; line-height: normal;">New Features</span>
        <br>
        1. Tickets now uses the Droid-serif font. If your browser supports the new css3 font face it will automaticlly switch to that font. <br>
        <br>
        <span style="font-size: 150%; line-height: normal;">Known Issues</span>
        <br>
        1. Large Graphs are still not working properly <br>
        ...
        <span style="font-size: 150%; line-height: normal;">Bug Fixes</span>
        <br>
        1. Fixed some spelling problems. <br>
        2. Closing and reopening of tickets should be a lot faster. <br>
        3. Fixed the bug from [ticket=450]. <br>
        4. The ticket list is now the same height as the ticket area. <br>
        5. Fixed the bug from [ticket=451]. <br>
        6. Fixed some theme issues relating to fonts. <br>
        7. Ticket lists now fit inside the default window height. There is a scroll bar inside the page to see tickets that can not be seen. <br>
        8. Ticket list now shows more relavant information about each of the tickets. Including due on, completed on, and over dy by. This was always intended and was not working properly. <br>
        <br>
        <span style="font-size: 150%; line-height: normal;">New Features</span>
        <br>
        1. Ticket lists now show the same icons as the normal ticket view. <br>
        2. Ticket lists have been reorganized a bit. The created by link is now on the right instead of the left. <br>
        <br>
        <span style="font-size: 150%; line-height: normal;">Known Issues</span>
        <br>
        1. Large Graphs are still not working properly <br>
        ...
        <span style="font-size: 150%; line-height: normal;">Bug Fixes</span>
        <br>
        1. Fixed a bug that was causing tickets that you reassigned to be shown in the side area as if you created them. <br>
        2. Fixed a long standing bug that was not filtering some of the show all areas by the logged in user <br>
        3. Fixed a bug with the start page not showing tickets if they were old and got a new response since your last visit. <br>
        4. Fixed the bug from <a class="ticket" href="ticket/434">ticket 434</a>. <br>
        <br>
        <span style="font-size: 150%; line-height: normal;">New Features</span>
        <br>
        1. New start page. <br>
        1.1 Tickets that have been worked on since your last visit are now shown instead of the update notes. Update notes are still accessable though the link in the top right corner. <br>
        1.2 Ticket lists have been reworked along side the crusade to banish the table tag. <br>
        2. Tickets is using the rounded corner CSS from the theme generator now. This will insure that the corners look correct. <br>
        3. New look to tickets and replies. More table tags squashed! <br>
        4. Ticket lists now show the same icons as the normal ticket view. <br>
        <br>
        <span style="font-size: 150%; line-height: normal;">Known Issues</span>
        <br>
        1. Large Graphs are still not working properly <br>
        ...
        <span style="font-size: 150%; line-height: normal;">Bug Fixes</span>
        <br>
        1. Fixed a bug that was preventing any favorite tickets from showing the proper icon. <br>
        1. Tickets is now working in Opera, as well as versions of Firefox prior to 3.1. <br>
        <br>
        <span style="font-size: 150%; line-height: normal;">New Features</span>
        <br>
        1. Ticket types are now in. They are <span class="bug">bug tickets</span> and <span class="ticket">trouble tickets</span>. <br>
        <blockquote>
          be sure to choose the proper type of ticket. Bug reports should be fixed for web code and things that can be fixed, but probably not related to computers. While trouble tickets are for everything that is not a bug.
        </blockquote>
        <br>
        2. Recent tickets should now be working properly. <br>
        <br>
        <span style="font-size: 150%; line-height: normal;">Known Issues</span>
        <br>
        1. Large Graphs are still not working properly <br>
        ...
        <span style="font-size: 150%; line-height: normal;">Bug Fixes</span>
        <br>
        1. Fixed some bugs relating to the new theme definitions. <br>
        2. Removed uploads as they were not being used and caused lots of bugs. <br>
        3. Fixed some email issues that crept up. <br>
        4. Fixed some small graphical issues relating to the sprite. <br>
        5. Fixed a javascript mistake that was preventing favorites from working properly. <br>
        6. Fixed a bug that was causing the buttons to disapear on a ticket. <br>
        7. Fixed the javascript error relating to tick.status. <br>
        <br>
        <span style="font-size: 150%; line-height: normal;">New Features</span>
        <br>
        1. User links. You can now link to a search of all tickets created by a user with [user=1321] <br>
        2. Tickets now uses the newest version of http://www.jquery.com"Jquery! <br>
        3. Dater is now part of tickets! <br>
        3.1 Enjoy selecting due dates with a new popup date selector. <br>
        4. <del>Url links are now in. [url=http://www.google.com] would create a URL link looking like <a class="globe" href="http://www.google.com">http://www.google.com</a></del>
        <br>
        5. Moving to a new naming convention for ticket updates. They will be numbered instead of just putting in the date <br>
        <br>
        <span style="font-size: 150%; line-height: normal;">Known Issues</span>
        <br>
        1. Tickets is currently having issues in Opera <br>
        2. Large Graphs are still not working properly <br>
        3. Recent Tickets are not updating like they should <br>
        4. Some themes do not work 100% <br>
        5. There are no page numbers, nor any way to show more then the default amount of tickets in the list view. <br>
        <br>
      </div>
    </div>
  </div>