<div class="fontMain" style="height:auto;width:100%;padding:0px 0px 4px 0;position:relative;text-align:right;" id="topper" title="Header of document">
	<div class="" id="areaBar" style="width:100%;display:block">
		<div style="display:table;width:100%;text-align:right;">
			...
			<div style="display:table-cell;width:30px;height:auto;vertical-algin:top;position:relative;"><!-- Start of Tab 1 -->
				<div id="ticketTab" class="tab selectedTab border-bottom-Main-1" >
					<a class="ticket_button ticket_sprite ticket nolink fontMain" href="#login" id="topperUserInfo" style="padding-right:5px;width:auto;text-decoration:none;">Tickets</a>
				</div>
			</div>	
			<div style="display:table-cell;width:30px;height:auto;vertical-algin:top;position:relative;"><!-- Start of Tab 2 -->
				<div id="bugTab" class="tab border-bottom-Main-1">
					<a class=" ticket_button ticket_sprite bug nolink fontMain" href="#login" id="topperUserInfo" style="padding-right:5px;width:auto;text-decoration:none;">Bugs</a>
				</div>
			</div>	
			<div style="display:table-cell;width:30px;height:auto;vertical-algin:top;position:relative;"><!-- Start of Tab 3 -->
				<div id="searchTab" class="tab border-bottom-Main-1">
					<a class=" ticket_button ticket_sprite magnifier nolink fontMain" href="#login" id="topperUserInfo" style="padding-right:5px;width:auto;text-decoration:none;">Search</a>
				</div>
			</div>	
