	...
	<div id="1replyareabody" style="padding:3px;">
		<form name="newReplyForm" id="newReplyForm">
			<div class="textLeft">
			  ...
			  <input type="text" name="title" autocomplete="off" maxlength="100" id="replyTitleBox" class="Ticketform roundAll4 border-all-B-2 fontMain" style="padding:2px;width:400px;"/><br>
