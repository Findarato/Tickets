<table cellpadding="0" cellspacing="0" style="width:99%;height:500px;">
	<tr style="width:100%">
		<td id="ticketListarea" style="padding-left:1px;vertical-align:top;height:500px;" class="">
			<div class="ui-corner-all dark border-main-1" style="text-align:left;text-align:left;margin:4px;padding:2px;height:20px;position:relative">
				<font style="margin:5px;">Tickets</font>
			...
			<div style="width:100%;vertical-align:top; " class="color-off">
				<div style="overflow:auto;height:430px;padding:4px" ><div class=" border-main-1 color-heavy " style=""><font id="ticketListbody" class="color-darkest ui-corner-all"></font></div></div>	
