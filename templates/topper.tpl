<div class="dark fg-toolbar ui-helper-clearfix" style="height:30px;overflow:hidden;" id="topper">
	<div class="fg-buttonset ui-helper-clearfix"> 
		...
		<div class="option-purple fg-button corners-bottom-2 corners-top-2 lapcatButton white" id="topperNewBug" style="width:auto"><span class="ticket_button ticket_sprite bug">New Bug Report</span></div>
