<div class="color-D-1 border-B-1 ui-corner-all" style="text-align:left;padding-left:3px;">
	<table width="100%">
		<tr>
			<td style="padding-right:5px;"><div class="font-X ticket_sprite user">Current Department is:</div></td>
			<td><div><span id="userDepartmentName" class="font-L font-bold">{$departmentName}</span></div></td>
		</tr>
		<tr>
			<td style="padding-right:5px;"><div class="font-X ticket_sprite department">Select your Department</div></td>
		...
		<tr>
			<td style="padding-right:5px;"><div class="font-X ticket_sprite email">Follow your Department</div></td>
			<td><div><input class="dropdown" value="1" id="userDepartmentNotify" type="checkbox" checked="{$notifyCheck}"></div></td>
		</tr>
		<tr>
			<td style="padding-right:5px;"><div class="font-X ticket_sprite email">Ticket Specific Email</div>	</td>
