<div class=" " style="height:500px;width:auto;margin-left:5px;">
	...
	<div class="message_body colorWhite-1 corners-bottom-2" id="" style="height:451px;">
		...
		<div class="box_transition textMessages" style="opacity:0;color:#f00;font-weight:bold;display:inline-block;" id="loginErrorMessage">
		</div>
		<div class="" id="forgotPasswordBox" style="width:400px;margin:10px 0 10px 0;height:0;overflow:hidden;">
			...
			<div style="float:left;">
				<button class="fontReverse minimal ticketPadding3" id="forgotPasswordSubmitButton" style="width:auto;">
					Request
				</button>
			</div>
